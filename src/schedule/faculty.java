...
public class faculty {
	...
	private void initialize() {
		...
		JLabel lblUniversityEditPage = new JLabel("Faculty Edit Page");
		...
		JLabel lblUniversityName = new JLabel("First Name");
		
		textField = new JTextField();
		textField.setColumns(10);
		
		JLabel lblAbbrevation = new JLabel("Last Name");
		...
		JLabel lblGradSchool = new JLabel("No of Courses");
